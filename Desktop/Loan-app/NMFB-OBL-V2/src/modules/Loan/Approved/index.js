...
import { useApprovedLoan } from "./hooks";
import { columns } from "../Column";
import ReactHTMLTableToExcel from "react-html-table-to-excel";
import { useIsFetching } from "@tanstack/react-query";
import { InfinitySpin } from "react-loader-spinner";
import styles from "../Pending/styles.module.css";
import { useSummary } from "../Pending/hooks";

const ApprovedLoan = () => {
  const data = useApprovedLoan();
  ...
  return (
    <Layout name="Loan Request" pageTitle="Approved Loan">
