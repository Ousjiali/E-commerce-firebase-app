...
import { WriteUpPage } from "../../ethics-policies/WriteUpPage";
import { AllPhotos } from "../champion-recognition/ethics-champion-activties/components/AllPhotos";
import { AllWriteUp } from "../champion-recognition/ethics-champion-activties/components/AllWriteUp";
import { ContentType } from "../../../../admin/pages/recognition/EthicsActivity";

export const RecognitionAllWriteUp = () => {
  ...
  const { data, isLoading } = useQuery<any>(["item"], async () => {
    try {
      const res = await sp.web.lists
        ...
        .items.filter(`ActivityType eq '${ContentType.Write_Up}'`)
        .getAll();
