  ...
  const nextHandler = () => {
    switch (role) {
      ...
      case "HCM Administrator":
        history.push("/level3confirmation");
        break;
      ...
      case "Senior Manager Employee Services":
        ...
        break;
      case "Employee":
        history.push("/view-supervisory/embployee");
        break;
      case "HRBP":
          ...
          <Card header="Leadership">
            <ul>
              <li>
                ...
                supervisory abilities this is it
              </li>
...
export default Level3Supervisory;
